package suzzingv.suzzingv.authservice.user.application.service;
...
import suzzingv.suzzingv.authservice.user.domain.enums.Role;
...
import suzzingv.suzzingv.authservice.user.util.VerificationCodeGenerator;
...
import suzzingv.suzzingv.commonmodule.sms.MessageUtils;
import suzzingv.suzzingv.commonmodule.sms.SmsSender;
